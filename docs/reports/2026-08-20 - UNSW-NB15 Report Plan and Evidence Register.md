...
| `PROJECT_NOTES.md` cites `notebooks/unsw_nb15_instructor_pipeline.ipynb`; no `.ipynb` exists (added in `fa1c106`, gone now) | Reproducibility claim in Part 3.7 | Confirm whether it was intentionally dropped in `c004ff6` |
