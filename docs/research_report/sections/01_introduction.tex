...
\begin{enumerate}
    ...
    a classification head trained on the semantic embeddings. The loop is reported under that
...
trained semantic consultant the feedback loop is the highest rung on both datasets, separated
from the graph model, from the fusion model and from every faithful re-trained baseline. With
