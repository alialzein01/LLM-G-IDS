...
Neither representation is assumed to win in every case. The central idea is
...
because a model ladder of GNN, semantic encoder, fusion and then feedback is only meaningful
