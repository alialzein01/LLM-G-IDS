...
$+0.0702$ [$+0.0359$, $+0.1035$] on NF-UNSW-NB15, separated, and $+0.0504$ [$-0.0091$,
$+0.1091$] on NF-ToN-IoT, not separated. The seed-matched interval on NF-ToN-IoT does exclude
...
On NF-ToN-IoT the feedback model is above the fusion model on seven of eight, losing only \texttt{password} at 0.2100
against 0.2950. Against the GNN model the feedback model is above on nine of ten NF-UNSW-NB15 classes
