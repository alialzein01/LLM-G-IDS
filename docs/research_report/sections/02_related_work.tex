...
approaches \citep{scarfone2007idps}, but either can be posed over a flow graph. A flow
...
statistics into natural-language descriptions, already exist in the literature.
...
Selecting uncertain graph elements for semantic consultation is also established.
...
refinement paradigm. Iterative semantic refinement is already an explicit
