...
This section first reviews graph-based intrusion detection and language models for security data. It then examines how structural and semantic representations are fused, reviews graph--language feedback mechanisms, and finally explains how this study relates to that work.
