...
mean in a fold-local whitened space. This is the ladder's semantic model and the
semantic input to the fusion model, and it measures what the encoder alone knows. The \emph{trained
