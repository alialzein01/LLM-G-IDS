...
One design variable is internal to the feedback model rather than a rung of the ladder: the identity of
the semantic consultant. The feedback model was first built around the whitened prototype scorer, the same
one the semantic model uses, and later around a per-fold classification head trained on
