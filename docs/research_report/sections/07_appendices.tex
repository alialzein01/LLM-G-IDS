...
The semantic branch is the only per-edge cost that would follow the system into deployment,
since it runs one frozen forward pass for each edge: at batch size 32 and a 128-token limit it
