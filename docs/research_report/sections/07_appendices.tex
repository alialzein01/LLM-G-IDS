...
regenerated with
\texttt{step3.build\_oof\_gnn\_embeddings} before the fusion stage whenever the GNN model changes. The fusion stage does not do it, and will otherwise train on stale
embeddings.
