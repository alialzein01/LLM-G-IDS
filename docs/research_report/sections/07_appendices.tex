...
fusion does not establish an improvement over the GNN on either dataset. The other part of RQ2 has a positive answer: fusion is separated above the prototype semantic model on both datasets (Table~\ref{tab:comparisons}). Therefore, an improvement over both single-branch stages is not established.
