...
Table~\ref{tab:disagreement} gives what happens where the two disagree, which is the only
place a consultant can change an answer.

\begin{table}[htbp]
\centering
\caption{Among entropy-flagged edges where the consultant and the graph encoder disagree, how
