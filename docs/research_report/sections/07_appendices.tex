...
\texttt{prototype\_superseded} in each dataset's selected-feedback config. Out-of-fold structural embeddings must be
regenerated with
...
explicit allowlist. \texttt{scripts/prose\_stats.py} measures the writing against the
