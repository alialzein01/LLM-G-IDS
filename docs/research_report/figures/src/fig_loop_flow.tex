...
\node[mech, anchor=north, text width=3.5cm] at (1.85,\rA-0.56)
      {the GNN model produces per-edge class logits\tr{one edge, probability mass over three classes}};
...
\node[leg] at (2.65,-6.27)
     {vermillion traces one illustrative edge, whose values are not measurements; grey is the $85.5\%$ of edges that never enter the feedback model.};
