...
\node[fbox, text width=1.9cm] (agaf) at (13.75,1.25) {AGAF:\\ gated attention fusion};
\node[lbox, text width=1.9cm] (loop) at (13.75,-1.25) {feedback loop};
...
\draw[gflow] (gemb.east) -- node[ann, above, pos=0.62]{graph encoder} (15.10,3.0);
\draw[sflow] (semb.east) -- node[ann, above, pos=0.55]{semantic rung} (15.10,-3.0);
